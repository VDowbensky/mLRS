...
bool config_sbus(bool enable_flag);
bool config_sbus_inverted(bool enable_flag);
...
bool InBase_parse_sbus(tRcData* rc)
{
...
void InBase_get_sbus_data(tRcData* rc)
{
