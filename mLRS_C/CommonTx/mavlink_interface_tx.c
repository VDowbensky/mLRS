...
{
  public:
    void tTxMavlink_Init(tSerialBase* _serialport, tSerialBase* _mbridge, tSerialBase* _serial2port);
    void tTxMavlink_Do(void);
    uint8_t tTxMavlink_VehicleState(void);
    void tTxMavlink_FrameLost(void);

    void tTxMavlink_putc(char c);
    bool tTxMavlink_available(void);
    uint8_t tTxMavlink_getc(void);
    void tTxMavlink_flush(void);
