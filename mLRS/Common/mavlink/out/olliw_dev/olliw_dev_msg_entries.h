...
#define FASTMAVLINK_MSG_ENTRY_RADIO_LINK_STATS_DEV  {421, 18, 18, 3, 0, 1}
#define FASTMAVLINK_MSG_ENTRY_RADIO_LINK_INFORMATION_DEV  {422, 172, 16, 3, 8, 9}
#define FASTMAVLINK_MSG_ENTRY_AUTOPILOT_STATE_FOR_GIMBAL_DEVICE_EXT  {60000, 4, 22, 3, 20, 21}
#define FASTMAVLINK_MSG_ENTRY_RADIO_LINK_STATS_MLRS  {60045, 185, 26, 3, 8, 9}
...
#define FASTMAVLINK_MSG_ENTRIES {\
  ...
  FASTMAVLINK_MSG_ENTRY_RADIO_LINK_STATS_MLRS,\
